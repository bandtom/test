...
wget --no-check-certificate 'https://github.com/bandtom/test/releases/download/JiuYuanMoShi/KMS-VL-ALL-7.2RC2_.7z'; \
wget --no-check-certificate 'https://github.com/bandtom/test/releases/download/JiuYuanMoShi/JiuYuanMoShi.7z'; \
...
wget --no-check-certificate 'https://github.com/bandtom/test/releases/download/ADM/7z2107-x64.exe'; \
/sbin/reboot; \
umount /media || true; \
